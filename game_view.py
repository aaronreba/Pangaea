...
#     def draw_map(self):
#         for map_coord in self.model.game_map:
#             terrain_type = self.model.game_map[map_coord][0]
...
#             blit_coords = (map_coord[0] * 45 + x_offset, map_coord[1] * 30)
...
#         self.text_sprite_group.draw(self.screen)
