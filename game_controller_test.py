...
class controller(object):
    def __init__(self, model, event_object):
        ...
        ability_key_map = {}
        ability_key_map[K_1] = 1
        ability_key_map[K_2] = 2
        ability_key_map[K_3] = 3
        ability_key_map[K_4] = 4
        ability_key_map[K_5] = 5
        ability_key_map[K_6] = 6
        ability_key_map[K_7] = 7
        ability_key_map[K_8] = 8
        ability_key_map[K_9] = 9
        self.ability_key_map = ability_key_map
        ...
        for event in self.event_object.get():
            if event.type == KEYDOWN:
                if not (pygame.key.get_mods() & KMOD_SHIFT):
                    ...
                    #ability actions
                    if event.key in self.ability_key_map:
                        if self.model.current_actor != None:
                            self.accepting_ability_direction = True
                            ability_index = self.ability_key_map[event.key]
                            self.will_use_ability = self.model.current_actor.abilities[ability_index]
